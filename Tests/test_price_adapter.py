...
def test_crypto_adapter_success():
    ...
    mock_data = {
        "prices": [[1672531200000, 16500.0], [1672617600000, 16600.0]],
        "total_volumes": [[1672531200000, 1000000.0], [1672617600000, 1100000.0]],
    }
...
def test_get_prices_cache_hit():
    ...
    key = build_cache_key(
        request.ticker, request.start_date.isoformat(), request.end_date.isoformat()
    )
